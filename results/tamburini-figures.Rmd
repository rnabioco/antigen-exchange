...
params:
  ...
  mod_dir:       "~/Dropbox/Ryan/Projects/antigen-exchange/results/models/2023-10-21" # loading/saving ML models
...
# hsts <- wrap_plots(
#   hsts,
#   widths = c(1.12, rep(1, length(rf_typs) - 1)),
#   nrow = 1
# )
```
...
# plot_grid(
#   plot_grid(hsts, nrow = 2, rel_heights = c(1, 0.1)), bar_2,
#   mod_bxs$high, NULL,
#   mod_u, NULL,
#   ncol   = 2,
#   rel_widths = c(1, 0.5),
...
# plot_grid(
#   top,
#   plot_grid(mod_bxs$high, nrow = 1, ncol = 2, rel_widths = c(1, 0.5)),
#   ncol = 1,
#   labels = c("", "C"),
#   label_size = ttl_pt2 * 1.5
# )
