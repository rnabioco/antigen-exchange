...
plt_dc_typs <- levels(dc_dat$subtype)
...
```{r "EXTENDED 1-1", fig.width = 14, fig.height = 6, eval = FALSE}
...
```{r "EXTENDED 1-2", eval = FALSE}
lec_dat %>%
  group_by(subtype, tm, exp) %>%
  summarize(n = n(), .groups = "drop")
```

```{r "EXTENDED 1-3", fig.width = 9, fig.height = 6, eval = FALSE}
...
```{r "extended 3wk boxes", fig.width = 15, fig.height = 5, eval = FALSE}
...
```{r "extended 6wk boxes", fig.width = 15, fig.height = 5, eval = FALSE}
