...
C.  Ag-high module score is shown for Ag-high and predicted Ag-competent LECs
    ...
    Bonferroni correction to compare Ag-high vs Ag-competent and
    Ag-competent vs Ag-low cells for each LEC subset.
...
bx_lvls <- c("Ag-low", "single-high", "double-high")
...
```{r "Fig 3", fig.width = 14, fig.height = 19}
...
```{r "Fig S3", fig.width = 13, fig.height = 15}
# Create final figure
figS3 <- wrap_plots(rep_ex_bxs, ncol = 1) /
  ex_scat$`exp-2` /
...
```{r "CHIKV figure", fig.width = 15, fig.height = 17}
# CHIKV color palette
