...
Antigen persists in discrete stromal cell populations within the lymph node
...
C.  Ag-high module score is shown for Ag-high and predicted Ag-competent LECs
    for each timepoint.
D.  UMAP projections show Ag-high module scores for cLECs for each timepoint.
E.  The expression of select genes from the Ag-high (top) and Ag-low (bottom)
    modules is shown.
