...
* **Revise cell type annotations.
  The population assigned as epithelial cells express Cdh1 and Krt8 and lack
  expression of Pdpn and Pecam1.**

<br>

Expression of Cdh1, Krt8, Pdpn, and Pecam1 is shown below for cell types.

```{r "epithelial cells", fig.width = 8, fig.height = 4, eval = generate_plots}
...
### Comment 5 (a) {.tabset .tabset-pills}
