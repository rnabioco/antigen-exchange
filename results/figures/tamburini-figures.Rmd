...
# # Format source data
# SOURCE_DATA$fig1C <- fig1_dat$LEC %>%
#   select(cell_id = .cell_id, subtype, UMAP_1 = hUMAP_1, UMAP_2 = hUMAP_2)
```
...
# # Format source data
# SOURCE_DATA$fig1D <- ag_bx_dat$LEC %>%
#   select(cell_id = .cell_id, tm, subtype, Ag_score)
```
