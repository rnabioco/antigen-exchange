...
- [ ] &nbsp;Look at Zhang et al scRNA-seq data for non-stim control dataset for
      FL figure ([R2C8](#R2C8))
- [x] &nbsp;Revise cell type annotations, check epithelial cells ([R3C3](#R3C3))
- [x] &nbsp;Remove day 14 LECs from [Figure 2] that were used to train models
      ([R1C2](#R1C2))
...
- [ ] &nbsp;Additional Xenium analysis of Ag in medulla ([R2C7](#R2C7))
...
chikv_naive <- chikv_naive %>%
  ...
  mutate_meta(
    mutate,
    tm = 0,
    subtype = lec_subtype  # Set correct subtype column used for Lucas et al
  )
...
`r knitr::knit_child("cell-type-annotations.Rmd")`

`r knitr::knit_child("reviews.Rmd")`
